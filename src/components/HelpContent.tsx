...
const HelpContent = () => {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.sectionColumn}>
        <p>
          Use the four free cells to hold single cards temporarily.
        </p>
      ...
      <div className={styles.sectionRow}>
        ...
        <p>
          Tableau columns are randomly populated at game start.
          Stack cards in descending order, alternating colors.
        </p>
      </div>

      <div className={styles.sectionRow}>
        <p>
          Move cards between columns to organize your tableau.
      ...
      <div className={styles.sectionColumn}>
        <p>
          Use Undo to go back, Redeal to start a new game, and Nudge to suggest a move.
          If Nudge turns red, there are no moves left.
        </p>
        <img src="img/help/button.png" className={styles.image} />
      </div>

      <p className={styles.footer}>
        Created by <a href="https://jialincai.com" className={styles.link}>Jialin</a>
      </p>
    </div>
  );
};
